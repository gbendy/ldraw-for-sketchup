...
module LDraw
  ...
  def LDraw.add_materials
    LDraw.read_colors if @colors.nil?
  ...
  def LDraw.face2line(face)
    line = ""
    verts = LDraw.corner_vertices(face)
  ...
  #
  #
  def self.swap_points(ary, i1, i2)
  ...
  def LDraw.triangulate_face(*faces)
    ...
    verts = LDraw.corner_vertices(face).collect { |v| v.position.to_a }
  ...
  unless file_loaded?(scriptname)
    ...
    menu = UI.menu.add_submenu("Su2LDraw")
